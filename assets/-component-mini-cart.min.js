...
// src/mini-cart.js
var HHMiniCart = class extends LitElement {
  constructor() {
    super();
    this.locales = {
      isLoading() {
  ...
  handleBodyClick(e4) {
    if (e4.path?.some((node) => {
      return node.matches && node.matches("hh-mini-cart");
    })) {
      return true;
    }
    if (!e4.defaultPrevented && this.isOpen()) {
      this.toggle();
    }
  }
  isOpen() {
...
__publicField(HHMiniCart, "properties", {
  loading: {
    reflect: true
  },
  _trapFocus: {
...
__publicField(HHMiniCart, "styles", [visuallyHidden, css``]);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
//# sourceMappingURL=-component-mini-cart.min.js.map
